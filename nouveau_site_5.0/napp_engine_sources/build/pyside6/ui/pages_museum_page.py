...
class Pages_museumWindow(QMainWindow):
    def __init__(self, buffer):
        ...
        if not self.buffer.get('current_page'):
            self.buffer.set('current_page', 'pages_museum')
    ...
    def setup_ui(self):
        ...
        self.nascene_9 = NaSceneWidget(self.buffer, options={'manifest': self.buffer.get('data.museum.manifest.json'), 'baseData': self.buffer.get('data.pages_museum')})
        asyncio.ensure_future(self.nascene_9.load_manifest())
